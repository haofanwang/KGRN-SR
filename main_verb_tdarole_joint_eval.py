...
from models import ggnn_verb_role_joint_eval, top_down_baseline
...
def main():
    ...
    model = getattr(ggnn_verb_role_joint_eval, constructor)(verb_model, tda_role_module)
    ...
    utils.load_net(args.tda_model, [model.role_model])
    print('successfully loaded tda model {}!'.format(args.tda_model))
