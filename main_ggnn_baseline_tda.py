...
logging.basicConfig(filename ='./logs/main_ggnn_baseline_tda.txt', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
def main():
    ...
    parser.add_argument('--model_saving_name', default="main_ggnn_baseline_tda", type=str, help='saving name of the outpul model')
