...
from models import ggnn_verb_role_joint_eval, ggnn_baseline, ggnn_r2r, ggnn_r2v
...
def main():
    ...
    parser.add_argument('--verb_model', type=str, default='./trained_models/scratch_main_resnet.model', help='Pretrained verb model')
    ...
    if args.ggnn_model == './trained_models/train_full_main_ggnn_r2r.model':
        ggnn_model = getattr(ggnn_r2r, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
    elif args.ggnn_model == './trained_models/train_full_main_ggnn_r2v.model':
        ggnn_model = getattr(ggnn_r2v, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
    elif args.ggnn_model == './trained_models/train_full_main_ggnn_baseline.model':
