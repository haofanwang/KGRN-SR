...
class GGNN_Baseline(nn.Module):
    def __init__(self, convnet, role_emb, verb_emb, ggnn, classifier, encoder, query_composer, G2):
    ...
    def forward(self, v_org, gt_verb):
        ...
        out = torch.cat([feature2, out], dim=-1) # [batch_size*6, 1024+300+300+512+512]
        ...
        return role_label_pred, adj_r2v, out
...
def build_ggnn_baseline(n_roles, n_verbs, num_ans_classes, encoder):
    ...
    return GGNN_Baseline(covnet, role_emb, verb_emb, ggnn, classifier, encoder, query_composer, G2)