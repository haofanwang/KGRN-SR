...
class GGNN_Baseline(nn.Module):
    ...
    def forward(self, v_org, gt_verb):
        ...
        img = img.contiguous().view(batch_size * self.encoder.max_role_count, -1) # [192, 1024]
        #print("0",img.shape)

        verb_embd = self.verb_emb(gt_verb) # [32, 1024]
        #print("1",verb_embd.shape)
        role_embd = self.role_emb(role_idx)
        role_embd = role_embd.view(batch_size * self.encoder.max_role_count, -1) # [192, 1024]
        ...
        verb_embed_expand = verb_embed_expand.contiguous().view(batch_size * self.encoder.max_role_count, -1) # [192, 1024]
        #print("3",verb_embed_expand.shape)

        # [192, 1024], [192, 1024], [192, 1024]
        input2ggnn = img * role_embd * verb_embed_expand # [192, 1024]
        #print("5",input2ggnn.shape)
        ...
        out = self.ggnn(input2ggnn, mask) # [192, 1024]
        #print("7",out.shape)
