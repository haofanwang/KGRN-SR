...
from models import ggnn_verb_role_joint_eval, top_down_baseline, top_down_query_context
...
def main():
    ...
    parser.add_argument('--caq_model', type=str, default='', help='Pretrained tda model')
    ...
    model = getattr(ggnn_verb_role_joint_eval, constructor)(verb_model, caq_model)
    ...
    print('successfully loaded caq model {}!'.format(args.caq_model))
