...
from models import ggnn_r2r_tsne
...
model = getattr(ggnn_r2r_tsne, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
...
with torch.no_grad():
    ...
    np.save('tsne_features_r2r.npy',features_list)
    np.save('tsne_labels_id_r2r.npy',labels_id)
    np.save('tsne_labels_name_r2r.npy',labels_name)