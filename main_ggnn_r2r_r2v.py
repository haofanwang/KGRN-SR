...
from models import ggnn_r2r_r2v

import logging

logging.basicConfig(filename ='./logs/main_ggnn_r2r_r2v.txt', level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
...
def main():
    ...
    parser.add_argument('--model_saving_name', default="main_ggnn_r2r_r2v", type=str, help='saving name of the outpul model')
    ...
    model = getattr(ggnn_r2r_r2v, constructor)(encoder.get_num_roles(),encoder.get_num_verbs(), encoder.get_num_labels(), encoder)
